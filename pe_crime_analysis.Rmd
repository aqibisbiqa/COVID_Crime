...
### Hypotheses
**Hypothesis 1: Crimes committed by young, male, minority offenders is the most significant factor in increasing police employment the next year.**
...
We merged the dataframes containing state level police employment data and state level crime data to produce the following figures. Each observation represents a single state in a single year. Both employment rates and crime rates are normalized by the population of a state in a certain year based on Census data. Rather than looking at specific counts of a demographic group committing a certain crime (i.e. males committing arson in 2010 Arkansas) and drastically increasing our number of output variables, we simply look at aggregated, normalized crime rate in a state for a certain year.
...
As stated before, we make the assumption that changes in police employment take approximately one year before reacting to demographic shifts in crime rate. Similar to our previous analysis, we will merge the state-level police employment and crime data, but based on the next year of police employment. This results in 10% fewer observations as we only utilize crime rates from 2010-2018 and employment rates from 2011-2019. 

For each of the perspectives we look at (race, sex, age, and offense) we plot the normalized frequencies of each perspective against the police employment rate (either officer, civilian, or total) the following year. This allows us to view the correlation between each demographic group in isolation. We also create linear models for each of the employment rates using all the factors of a certain perspective, viewing their correlative effects in conjunction.
...
Using the four races recorded in the NIBRS format as factors in a linear model, we find varying results for each type of police employment. Only black and white crime are significant to officer rates, but black crime has a positive correlation while that of white crime is negative. For civilian rates, all the minority races are significant while white crime is not; this implies that people volunteer and join law enforcement mainly in response to minority crime. Lastly, all four races are significant predictors of total employment, but Native American and black crime are positively correlated white Asian and white crime are negatively correlated; one could interpret this as crime by the latter two races being deemed less threatening.

The scatterplots shown also give an idea as to the relationship of crime rates by different races in isolation with future employment rates. As Native American, Asian, and white crime increase, officer rates seem to decrease, while officer rate seems to increase with black crime. On the other hand, all the minority races have positive correlations with increasing civilian rates while white crime has negative (and almost) zero correlation; this reinforces the idea that white crime is perceived to be less threatening to civilians while minority crime (especially by Native Americans) leads to increases in employment.

Also of note is the cluster at the top left of the Officer and Total figures. Like before, this is easily identifiable as the DC cluster; however, removing this cluster does not make any significant changes to the model, so, for viewing convenience, it will not be shown.
...
The scatterplots show that the models for female crime are steeper in every case of employment type; this indicates that female crime is more polarizing and has a stronger correlative ability with employment rates. This is backed by the results from the linear models, showing that female crime is more significant than male crime in each case. Interestingly, female crime has a negative correlation with officer rate, but a positive correlation with civilian rate, while male crime has the exact opposite correlations. This implies that officers and civilians perceive crimes differently based on sex: members of the academy react strongly to male crime while society and volunteers react to female crime.
...
Of our demographic perspectives, age proves to be the least interesting, perhaps due to having the most factors. The linear model shows that only two age groups have significant correlation with some police employment rate. Offenders aged between 30 and 39 have a positive correlation for civilian rate, while offenders aged 90 or older have a strong negative correlation. For the former, a possible explanation is that much of civilian law enforcement falls within this age group, and more people volunteer as a result of someone they know personally committing a crime. On the other hand, people with a personal relationship with an offender 90 or older would evidently stray away from participating in the civilian force. Moreover, the elderly are usually considered as less threatening, which backs the results of the model.
...
Our results both support and deviate from our original hypotheses. In terms of the effect of crime rate on future police employment, 
we find that the most significant groups are either middle-aged, female, or minority offenders. Surprisingly, young offenders don't seem to have any significant correlation with police employment when modeled with offenders from other age groups. Also, while male crime was significant, it was much less so than female crime. In addition, our model from a race perspective evidently supports our hypothesis that minority offenders have the most significant effect on increasing future police employment. With these results, it seems that policing institutions disproportionately react towards crimes committed by the most marginalized groups in our society (women and minorities). This trend is alarming for opponents of traditional law enforcement, as our model suggests that policing will increase as the minority population grows. Figure 5 in the appendix also shows that police employment rates have been slightly decreasing over the 2010s; in conjunction with our model, we can conclude that police have flowed into areas with higher rates of female and minority crime, but even more police have flowed out of areas with higher rates of male or white crime.

In regards to the effectiveness of police employment, our models actually contradict our original hypothesis. Civilian employment shows a significant positive correlation with offense rate, implying that it is *not* a particularly effective solution to managing crime. With our whole dataset, officer rate and total employment rate were both negatively correlated with offense rate, but this was in large part due to the low crime rates and high employment rates of the District of Columbia; removing those points resulted in both rates becoming positively correlated with offense rate, implying that the majority of states' policing institutions are not effective in reducing crime. This leads one to wonder why employment and crime rates are exceptionally high and low, respectively, in the District of Columbia (a topic of potential future research).

The main one should takeaway from this study is that US policing institutions are imperfect. Whether they are publicly addressed or not, inherent biases exist within law enforcement as employment changes disproportionately with the demographics of offenders. Moreover, law enforcement is not as effective as believed by the vast majority of Americans. All this is to say that alternative methods to peacekeeping should be considered and tested. As Patrick Sharkey suggests, we should commit to a community based approach for the next 10 years, even through the inevitable controversies, triumphs, and debate. As evidenced in this study, we've already seen the successes and pitfalls of traditional policing this past decade. Perhaps it's time to experiment with some alternatives for the new one.

#### *Limitations*

The single biggest limitation to this study is the size of our data set and the computational resources at hand. With every incident ever recorded in the past decade, we have enormous potential for police employment and crime rate analysis. However, we've chosen to look at yearly rates, rather than a more granular monthly or weekly approach. This decreases the number of data points we have to feed into our model, limiting our total number of variables. And in turn, this forces us to look at several different perspectives in a vacuum rather than combining demographic features (i.e. we can look at the effect of black or white crime and the effect of male or female crime, but not the exact effect of white and male crime versus black and female crime).

#### *Future Work*

Several parts of the structure of this study were designed with future expansion in mind. Some obvious next steps are to include the 16 states not included in the study as they transition over to the NIBRS data format. We can also take a more granular approach to our time steps; rather than looking at counts for each year, we can look by month for more data points and a potentially more accurate model. In such a scenario, we could play around with the lag period of employment change reaction, increasing or decreasing from our assumption of 1 year. Perhaps the most ambitious future project would be creating a Hidden Markov Model from our data, monitoring states and probabilities as more data is introduced into our dataset and being able to predict both employment and crime rates into the future. Such a model would be beneficial in informing states of where to concentrate police effectively. 

---

# Bibliography

Braga, Anthony A., et al. “The Effects of Hot Spots Policing on Crime: An Updated Systematic Review and Meta-Analysis.” *Justice Quarterly*, vol. 31, no. 4, 2012, pp. 633–663., doi:10.1080/07418825.2012.673632. 

Karma, Roge. “How Cities Can Tackle Violent Crime without Relying on Police.” *Vox*, Vox, 7 Aug. 2020, www.vox.com/21351442/patrick-sharkey-uneasy-peace-abolish-defund-the-police-violence-cities. 

Phelan, John. “Research Shows That More Cops Mean Less Crime.” *Center of the American Experiment*, 14 Sept. 2020, www.americanexperiment.org/research-shows-that-more-cops-mean-less-crime/. 

Saad, Lydia. “Black Americans Want Police to Retain Local Presence.” *Gallup.com*, Gallup, 5 Aug. 2020, news.gallup.com/poll/316571/black-americans-police-retain-local-presence.aspx. 

Sharkey, Patrick. “Perspective | Cops Prevent Violence. But They Aren't the Only Ones Who Can Do It.” *The Washington Post*, WP Company, 12 June 2020, www.washingtonpost.com/outlook/2020/06/12/defund-police-violent-crime/. 

Sherman, Lawrence W. *Evidence-Based Crime Prevention.* Routledge, 2006. 

Watkins, Matt, and Matt Watkins. “Keeping the Peace: Patrick Sharkey on Sustaining the Great Crime Decline.” *Center for Court Innovation*, 1 June 2018, www.courtinnovation.org/publications/patrick-sharkey-podcast. 

---

# Appendix

This section contains several additional figures, many of which were used in exploratory data analysis or referenced above. Commentary and interpretations are provided for select figures.

### Police Employment

```{r map-average-officer-pe}
...
**Fig. 1:** Average officer employment per 1000 citizens across US (2010-2019). Darker tones indicate higher rates of employment.

```{r map-officer-pe-over-time}
...
**Fig. 2:** Officer employment over time. 

```{r map-average-civilian-pe}
# for civilians
state_summary <- pe_recent %>% 
  group_by(state) %>% 
...
**Fig. 3:** Average civilian employment per 1000 citizens across US (2010-2019).

```{r map-civilian-pe-over-time}
# Maps of Police Employment for each year
pe10 <- plot_usmap(data=filter(pe_recent, data_year==2010),
...
**Fig. 4:** Civilian employment over time. 

```{r pe-average-over-time}
#make lines thicker
...
**Fig. 5:** Police employment per 1000 citizens on national scale.
...
**Fig. 6:** National proportion of civilians in law enforcement
...
**Fig. 7:** National proportion of females in law enforcement
...
**Fig. 8:** Normalized average turnover in police employment across US from 2010 to 2019.

Using standard deviation and normalizing techniques, we visualize the average turnover in total police employment for each state. Values less than 1 indicate low rates of turnover.
...
**Fig. 9:** Most Commonly Committed Crimes (2010-2019)

The 10 crimes denoted here are the only ones available for national-level query from the CDE API. Note that property-crime includes arson, larceny, robbery, and burglary offenses.
...
**Fig. 10:** Total Offenses Over Time (2010-2019)

```{r crime-over-time-race}
temp <- offenses_df %>% 
...
**Fig. 11:** Total Offenses by Crime and Race Over Time (2010-2019)

```{r crime-over-time-sex}
temp <- offenses_df %>% 
...
**Fig. 12:** Total Offenses by Crime and Sex Over Time (2010-2019)

```{r crime-over-time-age}
# what do I want?
...
**Fig. 13:** Total Offenses by Crime and Age Over Time (2010-2019)